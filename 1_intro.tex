...
% 
On average, \manic is $XX\times$ \graham{DATA} more energy efficient than a scalar baseline and $12\%$ more energy-efficient than a vector baseline.
...
% 
Compared to \snafu, \riptide uses 25\% less energy and is also XX\%\graham{DATA} faster without requiring hand-coded assembly.
% 
