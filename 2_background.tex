...
% costs energy to save and restore state and 
...
% 
Specifically, most prior CGRAs target much higher power domains (0.1-1W~\cite{weng2020dsagen,karunaratne2017hycube,nowatzki:isca17:stream-dataflow,tan2018stitch,weng2020hybrid} or even up to 100\,W~\cite{plasticine,voitsechov2014single}),
...
In contrast, this thesis presents \snafu and \riptide, which are designed from the ground-up to minimize energy (even at the expense of area and performance) while maximizing flexibility.
% 
