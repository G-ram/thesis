...
% 
Its generated CGRAs implement spatial-vector-dataflow execution that spatially lays out computation across a fabric of PEs, keeping each PE configured in the same way throughout kernel execution.
% 
