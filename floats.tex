...
\newcommand{\figProgress}{
  \begin{figure}[htb]
    ...
    \begin{subfigure}{0.49\linewidth}
      \centering
      \includegraphics[width=0.8\linewidth]{figures/pdf/progress_energy-graph-crop.pdf}
    ...
    \begin{subfigure}{0.49\linewidth}
      \centering
      \includegraphics[width=0.8\linewidth]{figures/pdf/progress_perf-graph-crop.pdf}
      \caption{Speedup.}
      \label{fig:progress:speedup}
    \end{subfigure}

    \caption{Energy savings and speedup v. MSP430 for neural network inference. \riptide saves $1676\times$ energy and is $235\times$ faster v. the MSP430.}
    \label{fig:progress}
  \end{figure}
}