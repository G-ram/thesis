...
\newcommand{\figMANICMANIC}{
	\begin{figure*}[htb]
		...
		\protect\autoref{fig:vde:issue} shows \manic's issue logic, which constructs
		windows of instructions that exhibit dataflow. \protect\autoref{fig:vde:execute} show
