...
\begin{figure}[t]
	\begin{minipage}{0.55\columnwidth}
		...
		\begin{subfigure}{\linewidth}
			...
			\resizebox{0.6\linewidth}{!}{
				\begin{tabular}{p{1in}p{0.3in}}
					\toprule
					Size (KB) & 256 \\
					Area (mm$^2$) & 0.31 \\
					Voltage (V) & 1.1 \\
					Leakage (\textmu W) & 663 \\
					32b Read Latency @ \newline 50 MHz (ns) & 170 \\
					32b Write Latency @ \newline  50 MHz (\textmu s) & 8.4 \\
	...
	\begin{minipage}{0.375\columnwidth}
		\begin{subfigure}{\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figures/pdf/mram_case-graph-crop.pdf}
	...
	\begin{minipage}{\columnwidth}
		...
		\begin{subfigure}{\linewidth}
			\resizebox{0.85\linewidth}{!}{
				\begin{tabular}{p{0.005in}p{3.25in}}
					%% \toprule
