\newcommand{\figRipTideIntroResults}{
  \begin{figure}[t]
    ...
    \end{minipage}
	    ...
	    \caption{\riptide improves energy efficiency and performance on average across ten benchmarks over the
...
\newcommand{\figRipTideIntro}{
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.65\linewidth]{riptide/figures/pdf/new_overview.pdf}
    \caption{\riptide is a co-designed compiler and CGRA architecture
      ...
      and irregular memory accesses, while minimizing the energy overhead.
      %
...
\newcommand{\figRipTideSATResults}{
	\begin{figure}[htb]
		...
		\begin{subfigure}{0.49\linewidth}
			\begin{Overpic}{
		      \includegraphics[width=0.85\linewidth]{riptide/figures/pdf/ctime-graph-crop.pdf}
		    }
		    \put (17,57){
		    	\includegraphics[height=0.2in]{riptide/figures/pdf/ctime_tlegend-graph-crop.pdf}
		    }
		  \end{Overpic}
			\caption{Compilation time.}
			\label{fig:riptide:sat:ctime}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.49\linewidth}
			\vspace{-0.6em}
			\includegraphics[width=0.85\linewidth]{riptide/figures/pdf/sat-graph-crop.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.7\linewidth]{riptide/figures/pdf/cf.pdf}
	\caption{Semantics of control-flow operators in \riptide.}
...
\begin{figure*}[t]
	...
	\caption{\riptide's frontend and middle-end components. The frontend
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.6\linewidth]{riptide/figures/pdf/lso.pdf}
	\caption{\riptide's middle-end enforces memory ordering. For 
	...
	\resizebox{\linewidth}{!}{
		...
		\begin{tabular}{p{0.4in}P{1.25in}P{1.25in}P{1.25in}P{1.25in}P{1.25in}P{1.35in}}
			...
			\bf Goal & 
				...
				\raisebox{-.3\height}{\includegraphics[height=0.125in]{riptide/figures/pdf/lightning.pdf}} Energy \\[4.5ex]
			\bf Power & 
			% 10s mW & 
...
\newcommand{\figRipTideArchRouter}{
\begin{figure*}[htb]
	\centering
...
\begin{figure*}[htb]
	...
	% 	No connection	 & - 		\\
	% 	Direct         & O = I 	\\
	% 	Steer      	 & (\autoref{fig:riptide:cf:gates}) \\
	% 	Carry	       & A = carry, I = init (\autoref{fig:riptide:cf:gates}) \\
	% 	Invariant      & (\autoref{fig:riptide:cf:gates}) \\
	% 	Select         & O = (D) ? I : A \\
	% 	Merge         & O = I || A \\
	...
	% 	\label{fig:riptide:micro:ops}
	% 	% \end{table}
	% \end{minipage}
\end{figure*}
}

\newcommand{\figRipTideArchPERouter}{
\begin{figure*}[t]
	\centering	
	\begin{minipage}{0.49\linewidth}
		\centering
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.85\linewidth]{riptide/figures/pdf/fin-graph-crop.pdf}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.55\linewidth]{riptide/figures/pdf/loc_legend-graph-crop.pdf}
	
	\vspace{0.1em}

	\includegraphics[width=0.85\linewidth]{riptide/figures/pdf/loc-graph-crop.pdf}
...
\begin{figure}[h]
	...
	\begin{subfigure}{0.49\linewidth}
		...
		\label{fig:riptide:progress:energy}
	\end{subfigure}
	\hfill
	\begin{subfigure}{0.49\linewidth}
		\centering
...
\newcommand{\figRipTideArea}{
  \begin{figure}[h]
  	\centering
    \includegraphics[width=0.4\linewidth]{riptide/figures/pdf/area_pie-crop.pdf}
...
\newcommand{\tabRipTideEvalCompare}{
  \begin{table*}[h]
	...
	\bf \makecell[c]{HyCube\\testchip$^\star$~\cite{wang2019hycube}} &
        \bf \makecell[c]{HM-HyCube\\REVAMP$\,^\diamond$~\cite{revamp}} &
	\bf \makecell[c]{UE-CGRA$^\dagger$\\\cite{torng2021ultra,torng_pan_2021}} &
%% 	\bf Revel$^\dag$~\cite{nowatzki2018hybrid} &
	\bf \makecell[c]{{\snafu}$^\diamond$\\\cite{snafu}} &
	\multicolumn{2}{c}{\makecell{\bf {\riptide}$^\diamond$\\\em(this work)}}\\ 
	\midrule
	Irregular loops &
	% \xmark & 
	% \xmark & 
...
%%       $^\dag$\,High-level simulation. \quad
    ...
    \caption{Comparison of \riptide to other low-power CGRAs.
      ...
      % \riptide's performance is lower than prior CGRAs;
      % \tmp{this is primarily due to its lower frequency}.
      }
