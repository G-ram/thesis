...
% 		\end{subfigure}
% 		\vspace{1.1em}
% 		\caption{\snafuarch v.\ the scalar design across three input sizes -- small (S), medium (M) and large (L).}
...
\newcommand{\figSNAFUSensInputResults}{
\begin{figure*}[t]
	\centering
	\includegraphics[width=0.5\linewidth]{snafu/figures/pdf/energy_all_norm_legend-graph-crop.pdf}\\
	\vspace{0.4em}
	...
	\end{subfigure}
	\hfill
	\begin{minipage}{0.001\linewidth}
	\end{minipage}
	\caption{\snafuarch v.\ the scalar design across three input sizes -- small (S), medium (M) and large (L).}
	\label{fig:snafu:sens:size}
\end{figure*}
...
\newcommand{\figSNAFUScratchResults}{
	\begin{figure}[t]
		\centering
		\includegraphics[width=0.5\columnwidth]{snafu/figures/pdf/energy_all_norm_legend-graph-crop.pdf}\\
		\vspace{0.4em}
		\begin{subfigure}{0.49\columnwidth}
			\centering
			\includegraphics[height=1.5in]{snafu/figures/pdf/case_scratch_norm-graph-crop.pdf}
			\caption{Energy.}
		...
		\begin{subfigure}{0.49\columnwidth}
			\centering
			\includegraphics[height=1.5in]{snafu/figures/pdf/case_scratch_perf-graph-crop.pdf}
			\caption{Speedup.}
